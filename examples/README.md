# Image Caption API - Examples

This folder contains example code for using the Image Caption API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/imagecaption',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/imagecaption");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/imagecaption](https://docs.apiverve.com/ref/imagecaption)
