...
```java
import com.apiverve.imagecaption.ImageCaptionAPIClient;
import com.apiverve.imagecaption.APIResponse;
import com.apiverve.imagecaption.APIException;

// Initialize the client
ImageCaptionAPIClient client = new ImageCaptionAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/imagecaption](https://docs.apiverve.com/ref/imagecaption)
...
- **Documentation:** [https://docs.apiverve.com/ref/imagecaption](https://docs.apiverve.com/ref/imagecaption)
- **Issues:** [GitHub Issues](https://github.com/apiverve/imagecaption-api/issues)
