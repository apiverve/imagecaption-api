// Package imagecaption provides a Go client for the Image Caption API.
//
// For more information, visit: https://apiverve.com/marketplace/imagecaption?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/imagecaption"
	defaultTimeout = 30 * time.Second
)

// Client is the Image Caption API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Image Caption API client.
...
// ExecuteWithFile makes a request to the Image Caption API with a file upload.
...
// Execute makes a request to the Image Caption API with typed parameters.
//
...
//   - image (required): string - Upload an image file to generate a caption (supported formats: JPG, PNG, GIF, max 5MB)
