...
class imagecaptionWrapper {
    ...
    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/imagecaption');
        }
        ...
        this.validationRules = {"image":{"type":"string","required":true}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/imagecaption`);
        }
    }
     ...
     * @param {Object} options - Additional options (e.g., additional form fields)
     * @param {Function} callback - Optional callback function
     * @returns {Promise} - Promise with the API response
     */
    async executeWithFile(file, options = {}, callback) {
        ...
        if (!file) {
            throw new Error('File must be provided for file upload. See documentation: https://docs.apiverve.com/ref/imagecaption');
        }
        ...
        if (typeof file === 'string') {
            ...
            throw new Error('File must be a file path (string), Buffer, or ReadStream. See documentation: https://docs.apiverve.com/ref/imagecaption');
        }
     ...
     * @param {string} url - URL of the file to process
     * @param {Object} options - Additional options (e.g., additional parameters)
     * @param {Function} callback - Optional callback function
     * @returns {Promise} - Promise with the API response
     */
    async executeWithUrl(url, options = {}, callback) {
        // Handle callback as second argument
        if (typeof options === 'function') {
            callback = options;
            options = {};
        ...
        if (!url || typeof url !== 'string') {
            throw new Error('URL must be provided as a string. See documentation: https://docs.apiverve.com/ref/imagecaption');
        }
...
module.exports = imagecaptionWrapper;
