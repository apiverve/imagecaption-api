...
namespace APIVerve.API.ImageCaption
{
    ...
    /// <summary>
    /// Client for the ImageCaption API
    /// </summary>
    public class ImageCaptionAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/imagecaption";
        ...
        {
            { "image", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public ImageCaptionAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ImageCaptionAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ImageCaptionAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ImageCaptionQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ImageCaptionQueryOptions options)
        {
        ...
        public ResponseObj Execute(ImageCaptionQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ImageCaptionQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ImageCaptionQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ImageCaptionQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ImageCaptionQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ImageCaptionQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ImageCaptionQueryOptions options)
        {
        ...
        /// <summary>
        /// Execute the API call with a file upload
        /// </summary>
        /// <param name="content">MultipartFormDataContent containing the file</param>
        /// <returns>Task containing the API response</returns>
        /// <exception cref="HttpRequestException">Thrown when the request fails</exception>
        public Task<ResponseObj> ExecuteWithFileAsync(MultipartFormDataContent content)
        {
            return ExecuteWithFileAsync(content, CancellationToken.None);
        }

        /// <summary>
        /// Execute the API call with a file upload and cancellation support
        /// </summary>
        /// <param name="content">MultipartFormDataContent containing the file</param>
        /// <param name="cancellationToken">Cancellation token to cancel the operation</param>
        /// <returns>Task containing the API response</returns>
        /// <exception cref="HttpRequestException">Thrown when the request fails</exception>
        /// <exception cref="OperationCanceledException">Thrown when the operation is cancelled</exception>
        public async Task<ResponseObj> ExecuteWithFileAsync(MultipartFormDataContent content, CancellationToken cancellationToken)
        {
            if (content == null)
            {
                throw new ArgumentNullException("content", "MultipartFormDataContent is required for file upload");
            }
            ...
            while (attempt <= _maxRetries)
            {
                try
                {
                    ...
                    return await ExecuteFileUploadRequestAsync(content, cancellationToken).ConfigureAwait(false);
                }
                catch (OperationCanceledException)
                {
                    throw;
                ...
                catch (Exception ex)
                {
                    ...
                    if (attempt > _maxRetries)
                    {
                        Log(string.Format("File upload failed after {0} retries: {1}", _maxRetries, ex.Message));
                        break;
                    }
            ...
            throw lastException ?? new HttpRequestException("File upload failed");
        }

        /// <summary>
        /// Executes the file upload HTTP request
        /// </summary>
        private async Task<ResponseObj> ExecuteFileUploadRequestAsync(MultipartFormDataContent content, CancellationToken cancellationToken)
        {
            try
            {
                Log("Executing file upload request...");
                Log(string.Format("URL: {0}", _apiEndpoint));
                ...
                // Add API key header (don't use default headers as they may have Content-Type set)
                request.Headers.TryAddWithoutValidation("x-api-key", _apiKey);
                request.Headers.TryAddWithoutValidation("auth-mode", "nuget");
                AddCustomHeadersToRequest(request);
            ...
            {
                Log(string.Format("File upload error: {0}", ex.Message));
                throw;
            }
        }

        /// <summary>
        /// Execute the API call with a file upload synchronously
        /// </summary>
        /// <param name="content">MultipartFormDataContent containing the file</param>
        /// <returns>The API response</returns>
        public ResponseObj ExecuteWithFile(MultipartFormDataContent content)
        {
            return ExecuteWithFileAsync(content).GetAwaiter().GetResult();
        }
#endif
    }
}
